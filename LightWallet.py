...
madeby = f"{COLOR.LIGHTGREEN}[i] {COLOR.DARKBLUE2}Made by {COLOR.BOLD}{COLOR.LIGHTBLUE1}ro{COLOR.LIGHTBLUE2}as{COLOR.BLUE1}te{COLOR.BLUE2}dt{COLOR.DARKBLUE1}oa{COLOR.DARKBLUE2}st{COLOR.END}"
